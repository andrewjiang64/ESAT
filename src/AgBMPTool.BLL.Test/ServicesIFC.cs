...
{
    public class ServicesIFC
    {
        //connection string should be read from configuration file
        private static string ConnectionString = "Host=localhost;Port=5433;Database=ESAT_IFC_Test_BulkInsert;Username=postgres;Password=123456";
